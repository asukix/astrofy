---
title: "Draft1v2"
description: Be courious like a child, understand as a professional and give curiousity to others
pubDate: "Jul 8 2026"
draft: true
---
...
When I am learning I like to slow down. I am curious and I like asking questions. Every one like asking questions because we like to explore. If you slow down to ask questions, you also give thinking space yourself. Providing space where you have time to find your own answers, to let yourself **to enjoy thinking**. Because when you find answers you will have time to enjoy the way, not just get the goal. This is a wonderful process where you can be yourself, where you can asking questions like a child and your thinking space can be your own playground that you can reach from anywhere without any tool.

## Understand the problem space
When I am thinking on a topic I like to change the base from the answers to the problem space. Every solution was born because someone wanted to solve a problem. If you understand the problem you will be able to get your own answers and build your own solution. With this you will have your own mental model. When you have your mental model you will be able to create your answers any time. What's more, you'll be able to create better answers later. In this process the creation is quite easy and the destruction is hard.
**Note:** I will write a separated article about destruction

## Validating of thinking
If you are start thinking on a topic and you start building your own mental models instead of accepting an existing one you need validation. You would like to know, that your hipothesys is good or not. I use the next ways for validation:
- Simply try it and I will know if it is working or not
- Checking the existing models: If my mental model is already existing and well known that means that was a valid thought. This not means your answer is wrong. This means you are able to make a good mental model.
- Explain it: When I try to explain something what I learnt it helps me to find my gaps. 
- Write it: I like writing. Writing a blog, a thinking article or a deep bit. It helps me to structure my knowledge and it gives time to think It again and again. And with write and explanition I feel that I can give back something useful.

## Understand better
I like the idea from Feynman. To try compress the information. This is what he said:
...
When you try to explain a topic in one sentence that helps you to understand it deeper.
